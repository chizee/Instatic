...
export function ArrowBigUpSharpIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect width="2" height="8" transform="matrix(1 0 0 -1 8 19)" fill={color}/>
      ...
      <rect width="2" height="8" transform="matrix(1 0 0 -1 14 19)" fill={color}/>
    </svg>
  );
}
