...
export function LoginSharpIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
      ...
      style={style}
    >
      <rect x="2" y="11" width="14" height="2" fill={color}/>
      ...
      <rect x="4" y="4" width="2" height="5" fill={color}/>
      <rect x="4" y="15" width="2" height="5" fill={color}/>
