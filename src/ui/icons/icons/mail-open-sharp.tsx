...
export function MailOpenSharpIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
      ...
      style={style}
    >
      <rect width="2" height="2" transform="matrix(1 0 0 -1 4 8)" fill={color}/>
      ...
      <rect x="20" y="8" width="2" height="2" transform="rotate(180 20 8)" fill={color}/>
      <rect width="2" height="2" transform="matrix(-1 0 0 1 18 12)" fill={color}/>
      <rect x="18" y="6" width="2" height="2" transform="rotate(180 18 6)" fill={color}/>
      <rect width="8" height="2" transform="matrix(1 0 0 -1 8 4)" fill={color}/>
