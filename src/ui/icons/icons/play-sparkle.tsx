...
export function PlaySparkleIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="4" y="19" width="8" height="2" fill={color}/>
      ...
      <rect x="22" y="17" width="2" height="2" fill={color}/>
