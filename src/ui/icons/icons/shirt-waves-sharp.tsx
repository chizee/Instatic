...
export function ShirtWavesSharpIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="14" y="21" width="4" height="2" fill={color}/>
      <rect x="18" y="15" width="4" height="2" fill={color}/>
      <rect x="18" y="19" width="4" height="2" fill={color}/>
    </svg>
  );
}
