...
export function CalendarAlertSharpIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="3" y="18" width="14" height="2" fill={color}/>
      <rect x="15" y="8" width="2" height="10" fill={color}/>
      <rect x="5" y="10" width="10" height="2" fill={color}/>
