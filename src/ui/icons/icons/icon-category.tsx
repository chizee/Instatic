...
export function IconCategoryIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect opacity="0.1" x="16" y="8" width="2" height="2" fill={color}/>
      <rect opacity="0.1" x="14" y="10" width="2" height="2" fill={color}/>
