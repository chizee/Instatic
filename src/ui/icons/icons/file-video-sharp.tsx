...
export function FileVideoSharpIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect width="4" height="2" transform="matrix(-1 0 0 1 20 20)" fill={color}/>
      ...
      <rect x="12" y="12" width="2" height="12" fill={color}/>
