...
export function ZapOffIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
      ...
      style={style}
    >
      <rect x="10" y="13" width="2" height="10" fill={color}/>
      <rect x="2" y="13" width="10" height="2" fill={color}/>
      <rect x="12" y="1" width="2" height="6" fill={color}/>
