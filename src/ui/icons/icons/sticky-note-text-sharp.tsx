...
export function StickyNoteTextSharpIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect width="14" height="2" transform="matrix(-1 0 0 1 16 2)" fill={color}/>
      <rect width="2" height="12" transform="matrix(-1 0 0 1 22 8)" fill={color}/>
      <rect width="20" height="2" transform="matrix(-1 0 0 1 22 20)" fill={color}/>
