...
export function ArticleSharpIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
      ...
      style={style}
    >
      <rect x="6" y="2" width="16" height="2" fill={color}/>
      ...
      <rect x="2" y="11" width="2" height="9" fill={color}/>
