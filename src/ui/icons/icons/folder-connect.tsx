...
export function FolderConnectIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="3" y="6" width="2" height="10" fill={color}/>
      <rect x="11" y="6" width="8" height="2" fill={color}/>
