...
export function DebugPlayIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="8" y="20" width="6" height="2" fill={color}/>
      ...
      <rect x="16" y="12" width="2" height="10" fill={color}/>
    </svg>
  );
}
