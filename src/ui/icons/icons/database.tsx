...
export function DatabaseIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    ...
    >
      ...
      <rect width="4" height="2" transform="matrix(1 0 0 -1 16 12)" fill={color}/>
      <rect width="4" height="2" transform="matrix(1 0 0 -1 16 16)" fill={color}/>
      <rect width="4" height="2" transform="matrix(1 0 0 -1 16 20)" fill={color}/>
      <rect x="8" y="2" width="8" height="2" fill={color}/>
      <rect width="8" height="2" transform="matrix(1 0 0 -1 8 14)" fill={color}/>
