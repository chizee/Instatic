...
export function Fence2SharpIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="21" y="5" width="2" height="16" fill={color}/>
      <rect x="1" y="3" width="6" height="2" fill={color}/>
      <rect x="9" y="3" width="6" height="2" fill={color}/>
      <rect x="17" y="3" width="6" height="2" fill={color}/>
      <rect x="7" y="17" width="2" height="2" fill={color}/>
      <rect x="7" y="9" width="2" height="2" fill={color}/>
      <rect x="15" y="9" width="2" height="2" fill={color}/>
