...
export function DicesSharpIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="1" y="21" width="14" height="2" fill={color}/>
      <rect x="13" y="11" width="2" height="10" fill={color}/>
      ...
      <rect x="21" y="7" width="2" height="4" fill={color}/>
