...
export function AudioDeviceSharpIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
      ...
      style={style}
    >
      <rect x="12" y="3" width="10" height="2" fill={color}/>
      <rect x="12" y="5" width="2" height="14" fill={color}/>
      <rect x="12" y="19" width="10" height="2" fill={color}/>
      ...
      <rect x="2" y="15" width="8" height="2" fill={color}/>
