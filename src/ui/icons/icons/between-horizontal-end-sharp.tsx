...
export function BetweenHorizontalEndSharpIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
      ...
      style={style}
    >
      <rect x="18" y="2" width="2" height="16" transform="rotate(90 18 2)" fill={color}/>
      ...
      <rect x="16" y="9" width="2" height="14" transform="rotate(90 16 9)" fill={color}/>
      <rect x="18" y="20" width="2" height="16" transform="rotate(90 18 20)" fill={color}/>
      <rect x="16" y="13" width="2" height="14" transform="rotate(90 16 13)" fill={color}/>
