...
export function CppIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="4" y="5" width="3" height="2" fill={color}/>
      <rect x="4" y="17" width="3" height="2" fill={color}/>
