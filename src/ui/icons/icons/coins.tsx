...
export function CoinsIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="15" y="14" width="2" height="4" fill={color}/>
      <rect x="14" y="12" width="3" height="2" fill={color}/>
    </svg>
  );
}
