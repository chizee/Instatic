...
export function CellularSignal3Icon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="18" y="4" width="2" height="14" fill={color}/>
      <rect x="2" y="16" width="2" height="3" fill={color}/>
      <rect x="9" y="12" width="2" height="6" fill={color}/>
      <rect x="16" y="6" width="2" height="12" fill={color}/>
