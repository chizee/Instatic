...
export function RepeatIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect width="2" height="10" transform="matrix(-1 0 0 1 5 7)" fill={color}/>
      ...
      <rect width="2" height="10" transform="matrix(1 0 0 -1 19 17)" fill={color}/>
    </svg>
  );
}
