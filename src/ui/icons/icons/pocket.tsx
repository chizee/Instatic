...
export function PocketIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="4" y="13" width="2" height="4" fill={color}/>
      <rect x="18" y="13" width="2" height="4" fill={color}/>
