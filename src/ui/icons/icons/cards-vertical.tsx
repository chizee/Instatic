...
export function CardsVerticalIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="18" y="2" width="2" height="8" transform="rotate(90 18 2)" fill={color}/>
      <rect x="18" y="16" width="2" height="8" transform="rotate(90 18 16)" fill={color}/>
      <rect x="14" y="20" width="2" height="8" transform="rotate(90 14 20)" fill={color}/>
