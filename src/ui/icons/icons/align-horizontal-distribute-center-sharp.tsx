...
export function AlignHorizontalDistributeCenterSharpIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect width="2" height="12" transform="matrix(1 0 0 -1 9 18)" fill={color}/>
      <rect width="2" height="8" transform="matrix(1 0 0 -1 19 16)" fill={color}/>
      ...
      <rect width="2" height="12" transform="matrix(1 0 0 -1 3 18)" fill={color}/>
      <rect width="2" height="8" transform="matrix(1 0 0 -1 13 16)" fill={color}/>
