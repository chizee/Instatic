...
export function ThumbsDown2LeftSharpIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
      ...
      style={style}
    >
      <rect x="22" y="15" width="2" height="14" transform="rotate(180 22 15)" fill={color}/>
