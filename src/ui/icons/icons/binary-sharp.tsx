...
export function BinarySharpIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="13" y="3" width="4" height="2" fill={color}/>
      ...
      <rect x="13" y="9" width="6" height="2" fill={color}/>
