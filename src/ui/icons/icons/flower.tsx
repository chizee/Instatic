...
export function FlowerIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="16" y="22" width="8" height="2" transform="rotate(180 16 22)" fill={color}/>
      <rect x="6" y="4" width="2" height="4" fill={color}/>
      <rect x="18" y="20" width="2" height="4" transform="rotate(180 18 20)" fill={color}/>
      ...
      <rect x="4" y="16" width="4" height="2" fill={color}/>
      <rect x="6" y="16" width="2" height="4" fill={color}/>
      <rect x="8" y="14" width="2" height="2" fill={color}/>
      <rect width="2" height="2" transform="matrix(-1 0 0 1 16 14)" fill={color}/>
      <rect x="10" y="12" width="2" height="2" fill={color}/>
      <rect width="2" height="2" transform="matrix(-1 0 0 1 14 12)" fill={color}/>
