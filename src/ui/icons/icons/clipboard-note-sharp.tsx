...
export function ClipboardNoteSharpIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
      ...
      style={style}
    >
      <rect x="20" y="12" width="2" height="8" fill={color}/>
      <rect x="10" y="10" width="12" height="2" fill={color}/>
      <rect x="10" y="20" width="10" height="2" fill={color}/>
      <rect x="10" y="12" width="2" height="8" fill={color}/>
      <rect x="6" y="2" width="8" height="2" fill={color}/>
      <rect x="6" y="6" width="8" height="2" fill={color}/>
      ...
      <rect x="16" y="6" width="2" height="5" fill={color}/>
