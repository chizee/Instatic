...
export function ArtTextMinimalSharpIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
      ...
      style={style}
    >
      <rect x="2" y="11" width="10" height="2" fill={color}/>
      <rect x="2" y="3" width="10" height="2" fill={color}/>
      <rect x="14" y="3" width="8" height="2" fill={color}/>
