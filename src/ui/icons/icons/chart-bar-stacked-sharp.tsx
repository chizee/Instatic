...
export function ChartBarStackedSharpIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="18" y="11" width="2" height="12" transform="rotate(90 18 11)" fill={color}/>
      <rect x="18" y="16" width="2" height="12" transform="rotate(90 18 16)" fill={color}/>
      ...
      <rect x="20" y="2" width="2" height="14" transform="rotate(90 20 2)" fill={color}/>
      <rect x="20" y="7" width="2" height="14" transform="rotate(90 20 7)" fill={color}/>
