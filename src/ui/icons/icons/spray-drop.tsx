...
export function SprayDropIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="3" y="19" width="6" height="2" fill={color}/>
      <rect x="9" y="11" width="2" height="10" fill={color}/>
