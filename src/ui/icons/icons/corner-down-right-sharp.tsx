...
export function CornerDownRightSharpIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect width="2" height="12" transform="matrix(1 0 0 -1 4 16)" fill={color}/>
