...
export function CloudComputingIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="3" y="20" width="4" height="2" fill={color}/>
      <rect x="17" y="20" width="4" height="2" fill={color}/>
