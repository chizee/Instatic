...
export function GalleryVerticalSharpIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
      ...
      style={style}
    >
      <rect x="22" y="6" width="12" height="2" transform="rotate(90 22 6)" fill={color}/>
      <rect x="20" y="6" width="2" height="16" transform="rotate(90 20 6)" fill={color}/>
      <rect x="4" y="6" width="12" height="2" transform="rotate(90 4 6)" fill={color}/>
