...
export function MailLeftIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect width="4" height="2" transform="matrix(-1 0 0 1 24 18)" fill={color}/>
      <rect width="2" height="6" transform="matrix(-1 0 0 1 18 16)" fill={color}/>
