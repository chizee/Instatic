...
export function Rain2Icon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
      ...
      style={style}
    >
      <g clip-path="url(#clip0_496_1450)">
      ...
      <rect y="22" width="2" height="2" fill={color}/>
      <rect x="8" y="22" width="2" height="2" fill={color}/>
      <rect x="16" y="22" width="2" height="2" fill={color}/>
      </g>
      <defs>
      <clipPath id="clip0_496_1450">
