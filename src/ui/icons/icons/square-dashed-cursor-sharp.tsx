...
export function SquareDashedCursorSharpIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
      ...
      style={style}
    >
      <rect x="12" y="10" width="2" height="12" fill={color}/>
      ...
      <rect x="20" y="2" width="2" height="4" fill={color}/>
