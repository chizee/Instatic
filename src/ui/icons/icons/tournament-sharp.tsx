...
export function TournamentSharpIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="14" y="5" width="2" height="14" fill={color}/>
      <rect x="7" y="13" width="2" height="10" fill={color}/>
