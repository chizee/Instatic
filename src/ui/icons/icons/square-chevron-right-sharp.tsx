...
export function SquareChevronRightSharpIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="11" y="7" width="2" height="2" transform="rotate(90 11 7)" fill={color}/>
      <rect x="13" y="13" width="2" height="2" transform="rotate(90 13 13)" fill={color}/>
      <rect x="11" y="15" width="2" height="2" transform="rotate(90 11 15)" fill={color}/>
    </svg>
  );
}
