...
export function AiAppWindowSharpIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="2" y="19" width="8" height="2" fill={color}/>
      ...
      <rect x="16" y="21" width="2" height="2" fill={color}/>
