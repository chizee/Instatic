...
export function BeerOffIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
      ...
      style={style}
    >
      <rect x="5" y="10" width="2" height="10" fill={color}/>
      ...
      <rect x="21" y="10" width="2" height="6" fill={color}/>
