...
export function ReceiptPlusSharpIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
      ...
      style={style}
    >
      <rect x="3" y="2" width="2" height="18" fill={color}/>
      <rect x="19" y="2" width="2" height="12" fill={color}/>
