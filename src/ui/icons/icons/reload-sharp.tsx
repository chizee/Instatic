...
export function ReloadSharpIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="2" y="6" width="18" height="2" fill={color}/>
      ...
      <rect x="22" y="18" width="18" height="2" transform="rotate(180 22 18)" fill={color}/>
    </svg>
  );
}
