...
export function Image2RightSharpIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
      ...
      style={style}
    >
      <rect x="2" y="2" width="10" height="2" fill={color}/>
      ...
      <rect width="2" height="10" transform="matrix(-1 0 0 1 20 0)" fill={color}/>
