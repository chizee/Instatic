...
export function FireExtinguisherSharpIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
      ...
      style={style}
    >
      <rect x="8" y="8" width="2" height="12" fill={color}/>
      <rect x="10" y="6" width="6" height="2" fill={color}/>
      <rect x="16" y="8" width="2" height="12" fill={color}/>
      <rect x="8" y="20" width="10" height="2" fill={color}/>
      ...
      <rect x="10" y="16" width="6" height="2" fill={color}/>
