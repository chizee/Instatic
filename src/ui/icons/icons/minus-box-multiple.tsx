...
export function MinusBoxMultipleIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
      ...
      style={style}
    >
      <rect width="10" height="2" transform="matrix(-1 0 0 1 19 3)" fill={color}/>
      <rect width="10" height="2" transform="matrix(-1 0 0 1 19 15)" fill={color}/>
      <rect width="10" height="2" transform="matrix(-1 0 0 1 15 19)" fill={color}/>
