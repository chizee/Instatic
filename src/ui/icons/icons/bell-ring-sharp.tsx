...
export function BellRingSharpIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="15" y="4" width="2" height="2" fill={color}/>
      <rect x="19" y="2" width="2" height="2" fill={color}/>
      <rect width="2" height="2" transform="matrix(-1 0 0 1 5 2)" fill={color}/>
      <rect x="21" y="4" width="2" height="2" fill={color}/>
      <rect width="2" height="2" transform="matrix(-1 0 0 1 3 4)" fill={color}/>
      <rect x="5" y="6" width="2" height="7" fill={color}/>
      <rect x="17" y="6" width="2" height="7" fill={color}/>
