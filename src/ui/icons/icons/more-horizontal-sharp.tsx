...
export function MoreHorizontalSharpIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="17" y="9" width="6" height="2" fill={color}/>
      ...
      <rect x="1" y="13" width="6" height="2" fill={color}/>
      <rect x="9" y="13" width="6" height="2" fill={color}/>
      <rect x="17" y="13" width="6" height="2" fill={color}/>
