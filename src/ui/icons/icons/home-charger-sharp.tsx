...
export function HomeChargerSharpIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className} style={style}>
      <rect x="2" y="20" width="7" height="2" fill={color}/>
      ...
      <rect x="11" y="20" width="11" height="2" fill={color}/>
