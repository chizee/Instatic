...
export function PrinterMinimalIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="2" y="10" width="2" height="6" fill={color}/>
      ...
      <rect x="16" y="14" width="2" height="6" fill={color}/>
