...
export function ThumbsDownLeftIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
      ...
      style={style}
    >
      <rect x="22" y="12" width="2" height="8" transform="rotate(180 22 12)" fill={color}/>
