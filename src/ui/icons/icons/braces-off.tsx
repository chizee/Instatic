...
export function BracesOffIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect width="4" height="2" transform="matrix(-1 0 0 1 18 3)" fill={color}/>
      <rect width="4" height="2" transform="matrix(1 0 0 -1 6 21)" fill={color}/>
