...
export function DownloadSharpIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="21" y="19" width="2" height="18" transform="rotate(90 21 19)" fill={color}/>
