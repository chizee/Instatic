...
export function AiSettingsIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect width="2" height="2" transform="matrix(1 0 0 -1 18 22)" fill={color}/>
      ...
      <rect width="2" height="4" transform="matrix(1 0 0 -1 18 18)" fill={color}/>
      ...
      <rect x="8" y="9" width="2" height="7" fill={color}/>
      <rect x="9" y="8" width="3" height="2" fill={color}/>
      <rect x="11" y="9" width="2" height="7" fill={color}/>
