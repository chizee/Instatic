...
export function CloudThunderRainIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <path d="M22 14H18V16H22V14Z" fill={color}/>
      <path d="M6 14H2V16H6V14Z" fill={color}/>
