...
export function PhoneForwardedIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
      ...
      style={style}
    >
      <rect x="4" y="1" width="5" height="2" fill={color}/>
      ...
      <rect x="17" y="13" width="4" height="2" fill={color}/>
      <rect x="21" y="15" width="2" height="5" fill={color}/>
      ...
      <rect x="17" y="1" width="2" height="10" fill={color}/>
