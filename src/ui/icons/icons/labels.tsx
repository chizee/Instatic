...
export function LabelsIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="6" y="4" width="2" height="6" fill={color}/>
      ...
      <rect x="18" y="8" width="2" height="4" fill={color}/>
      ...
      <rect x="16" y="14" width="2" height="4" fill={color}/>
