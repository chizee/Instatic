...
export function HeartMinusIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className} style={style}>
      ...
      <rect x="1" y="6" width="2" height="6" fill={color}/>
      ...
      <rect x="21" y="6" width="2" height="6" fill={color}/>
      ...
      <rect x="15" y="16" width="6" height="2" fill={color}/>
    </svg>
  );
}
