...
export function FlashlightOffSharpIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
      ...
      style={style}
    >
      <rect x="9" y="2" width="8" height="2" fill={color}/>
      <rect x="5" y="4" width="2" height="6" fill={color}/>
      <rect x="7" y="10" width="2" height="10" fill={color}/>
      <rect x="7" y="20" width="10" height="2" fill={color}/>
      <rect x="15" y="14" width="2" height="6" fill={color}/>
