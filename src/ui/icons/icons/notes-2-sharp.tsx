...
export function Notes2SharpIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
      ...
      style={style}
    >
      <rect width="16" height="2" transform="matrix(-1 0 0 1 22 2)" fill={color}/>
      ...
      <rect width="16" height="2" transform="matrix(-1 0 0 1 18 20)" fill={color}/>
