...
export function MapPinAreaIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="20" y="18" width="2" height="4" fill={color}/>
      <rect x="4" y="15" width="2" height="3" fill={color}/>
      <rect x="6" y="13" width="2" height="2" fill={color}/>
      <rect x="16" y="13" width="2" height="2" fill={color}/>
      <rect x="18" y="15" width="2" height="3" fill={color}/>
