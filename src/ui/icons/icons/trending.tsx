...
export function TrendingIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
      ...
      style={style}
    >
      <rect x="2" y="4" width="2" height="15" fill={color}/>
      <rect x="4" y="19" width="17" height="2" fill={color}/>
