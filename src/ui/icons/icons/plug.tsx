...
export function PlugIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="18" y="9" width="2" height="5" fill={color}/>
      <rect x="8" y="16" width="8" height="2" fill={color}/>
      <rect x="8" y="2" width="2" height="5" fill={color}/>
      <rect x="14" y="2" width="2" height="5" fill={color}/>
