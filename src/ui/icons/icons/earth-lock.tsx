...
export function EarthLockIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="20" y="14" width="2" height="4" fill={color}/>
      <rect x="8" y="4" width="2" height="4" fill={color}/>
      <rect x="4" y="12" width="2" height="2" fill={color}/>
      <rect x="10" y="16" width="2" height="4" fill={color}/>
      ...
      <rect x="14" y="5" width="6" height="2" fill={color}/>
      <rect x="12" y="5" width="2" height="7" fill={color}/>
      <rect x="14" y="10" width="6" height="2" fill={color}/>
      <rect x="20" y="5" width="2" height="7" fill={color}/>
      <rect x="14" y="3" width="2" height="2" fill={color}/>
      <rect x="16" y="1" width="2" height="2" fill={color}/>
