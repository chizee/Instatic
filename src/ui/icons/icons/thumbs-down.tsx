...
export function ThumbsDownIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
      ...
      style={style}
    >
      <rect width="2" height="8" transform="matrix(1 0 0 -1 2 12)" fill={color}/>
