...
export function AlignVerticalDistributeStartSharpIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect width="2" height="16" transform="matrix(-4.37114e-08 1 1 4.37114e-08 4 9)" fill={color}/>
      <rect x="7" y="18" width="3" height="2" transform="rotate(-90 7 18)" fill={color}/>
      <rect x="7" y="20" width="2" height="10" transform="rotate(-90 7 20)" fill={color}/>
