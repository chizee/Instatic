...
export function MicrosoftWordIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="5" y="12" width="3" height="1" fill={color}/>
      ...
      <rect x="12" y="11" width="10" height="2" fill={color}/>
