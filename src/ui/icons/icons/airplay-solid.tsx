...
export function AirplaySolidIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
      ...
      style={style}
    >
      <rect x="4" y="3" width="16" height="8" fill={color}/>
      ...
      <rect x="17" y="13" width="3" height="4" fill={color}/>
      <rect x="4" y="13" width="3" height="4" fill={color}/>
