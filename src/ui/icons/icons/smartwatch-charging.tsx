...
export function SmartwatchChargingIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="7" y="17" width="6" height="2" fill={color}/>
