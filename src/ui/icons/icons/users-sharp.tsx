...
export function UsersSharpIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="15" y="2" width="6" height="2" fill={color}/>
      <rect x="3" y="10" width="10" height="2" fill={color}/>
      <rect x="15" y="10" width="6" height="2" fill={color}/>
      ...
      <rect x="14" y="14" width="2" height="8" fill={color}/>
      <rect x="22" y="14" width="2" height="8" fill={color}/>
