...
export function GpsOffSharpIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
      ...
      style={style}
    >
      <rect x="11" y="5" width="8" height="2" fill={color}/>
      ...
      <rect x="17" y="7" width="2" height="6" fill={color}/>
      <rect x="7" y="17" width="10" height="2" fill={color}/>
      <rect x="5" y="7" width="2" height="12" fill={color}/>
