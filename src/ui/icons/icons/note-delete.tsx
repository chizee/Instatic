...
export function NoteDeleteIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="20" y="4" width="2" height="13" fill={color}/>
      <rect x="10" y="2" width="10" height="2" fill={color}/>
      <rect x="18" y="16" width="2" height="2" fill={color}/>
      <rect x="16" y="18" width="2" height="2" fill={color}/>
      <rect x="4" y="20" width="12" height="2" fill={color}/>
