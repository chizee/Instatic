...
export function CalendarDownloadSharpIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="11" y="16" width="8" height="2" fill={color}/>
      ...
      <rect x="15" y="12" width="2" height="10" fill={color}/>
    </svg>
  );
}
