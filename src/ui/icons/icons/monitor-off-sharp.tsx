...
export function MonitorOffSharpIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
      ...
      style={style}
    >
      <rect x="8" y="2" width="14" height="2" fill={color}/>
      <rect x="4" y="16" width="14" height="2" fill={color}/>
