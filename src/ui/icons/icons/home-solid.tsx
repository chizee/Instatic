...
export function HomeSolidIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className} style={style}>
      ...
      <rect x="15" y="10" width="7" height="10" fill={color}/>
      <rect x="2" y="10" width="8" height="10" fill={color}/>
      <rect x="4" y="8" width="2" height="2" fill={color}/>
      <rect x="6" y="6" width="2" height="2" fill={color}/>
      <rect x="8" y="4" width="8" height="4" fill={color}/>
      ...
      <rect x="14" y="14" width="3" height="6" fill={color}/>
      <rect x="6" y="8" width="12" height="6" fill={color}/>
    </svg>
  );
}
