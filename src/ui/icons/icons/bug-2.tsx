...
export function Bug2Icon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="3" y="17" width="2" height="4" fill={color}/>
      <rect x="19" y="17" width="2" height="4" fill={color}/>
      <rect x="19" y="11" width="4" height="2" fill={color}/>
      <rect x="1" y="11" width="4" height="2" fill={color}/>
      <rect x="19" y="3" width="2" height="4" fill={color}/>
