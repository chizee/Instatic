...
export function PowerpointFileIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect width="4" height="2" transform="matrix(-1 0 0 1 18 20)" fill={color}/>
      ...
      <rect x="2" y="22" width="8" height="2" fill={color}/>
