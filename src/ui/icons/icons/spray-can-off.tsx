...
export function SprayCanOffIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="5" y="21" width="12" height="2" fill={color}/>
      <rect x="15" y="9" width="2" height="4" fill={color}/>
      <rect x="5" y="9" width="2" height="12" fill={color}/>
      <rect x="9" y="17" width="6" height="2" fill={color}/>
      <rect x="9" y="13" width="2" height="6" fill={color}/>
      ...
      <rect x="19" y="21" width="2" height="2" fill={color}/>
