...
export function CigaretteOffSharpIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="4" y="11" width="9" height="2" fill={color}/>
      <rect x="4" y="15" width="13" height="2" fill={color}/>
      <rect x="7" y="13" width="2" height="2" fill={color}/>
      <rect x="17" y="11" width="3" height="2" fill={color}/>
      <rect x="20" y="11" width="2" height="6" fill={color}/>
