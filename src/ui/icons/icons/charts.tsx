...
export function ChartsIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="3" y="16" width="14" height="2" fill={color}/>
      <rect x="7" y="20" width="14" height="2" fill={color}/>
