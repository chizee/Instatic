...
export function Server3SharpIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="2" y="1" width="20" height="2" fill={color}/>
      <rect x="2" y="9" width="20" height="2" fill={color}/>
      <rect x="2" y="13" width="20" height="2" fill={color}/>
