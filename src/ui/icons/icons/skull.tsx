...
export function SkullIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="1" y="4" width="2" height="10" fill={color}/>
      <rect x="21" y="4" width="2" height="10" fill={color}/>
