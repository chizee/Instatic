...
export function SmartHomeOffSharpIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
      ...
      style={style}
    >
      <rect x="2" y="20" width="14" height="2" fill={color}/>
      ...
      <rect x="9" y="16" width="5" height="2" fill={color}/>
