...
export function MapMinusIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="14" y="6" width="2" height="10" fill={color}/>
      <rect x="8" y="2" width="2" height="16" fill={color}/>
