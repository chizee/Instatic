...
export function CableSharpIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="1" y="10" width="8" height="2" fill={color}/>
      <rect x="23" y="14" width="8" height="2" transform="rotate(180 23 14)" fill={color}/>
      ...
      <rect x="4" y="18" width="9" height="2" fill={color}/>
      <rect x="11" y="3" width="9" height="2" fill={color}/>
