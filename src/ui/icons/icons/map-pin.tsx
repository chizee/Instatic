...
export function MapPinIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect width="2" height="2" transform="matrix(-1 0 0 1 19 4)" fill={color}/>
      ...
      <rect width="2" height="8" transform="matrix(-1 0 0 1 21 6)" fill={color}/>
      <rect x="10" y="6" width="4" height="2" fill={color}/>
      <rect x="8" y="8" width="2" height="4" fill={color}/>
