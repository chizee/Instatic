...
export function AttachmentIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="19" y="7" width="12" height="2" transform="rotate(90 19 7)" fill={color}/>
      ...
      <rect x="17" y="19" width="2" height="6" transform="rotate(90 17 19)" fill={color}/>
