...
export function CardSpadesSharpIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="4" y="22" width="2" height="16" transform="rotate(-90 4 22)" fill={color}/>
      <rect x="4" y="4" width="2" height="16" transform="rotate(-90 4 4)" fill={color}/>
      <rect x="11" y="7" width="2" height="4" fill={color}/>
      <rect x="7" y="11" width="4" height="2" fill={color}/>
      <rect x="13" y="11" width="4" height="2" fill={color}/>
