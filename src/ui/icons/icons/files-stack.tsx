...
export function FilesStackIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="12" y="1" width="4" height="2" fill={color}/>
      ...
      <rect x="12" y="13" width="8" height="2" fill={color}/>
