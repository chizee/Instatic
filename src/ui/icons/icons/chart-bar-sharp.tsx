...
export function ChartBarSharpIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="16" y="10" width="2" height="8" fill={color}/>
      <rect x="6" y="14" width="2" height="4" fill={color}/>
      <rect x="20" y="10" width="2" height="8" fill={color}/>
      ...
      <rect x="9" y="4" width="2" height="14" fill={color}/>
      <rect x="13" y="4" width="2" height="14" fill={color}/>
