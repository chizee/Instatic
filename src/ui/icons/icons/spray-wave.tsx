...
export function SprayWaveIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect width="2" height="2" transform="matrix(1 0 0 -1 14 11)" fill={color}/>
      <rect x="16" y="3" width="2" height="2" fill={color}/>
      <rect width="2" height="2" transform="matrix(1 0 0 -1 16 13)" fill={color}/>
      <rect x="18" y="1" width="2" height="2" fill={color}/>
      <rect width="2" height="2" transform="matrix(1 0 0 -1 18 15)" fill={color}/>
