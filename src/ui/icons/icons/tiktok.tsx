...
export function TiktokIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
      ...
      style={style}
    >
      <rect x="11" y="4" width="2" height="14" fill={color}/>
      <rect x="15" y="6" width="2" height="14" fill={color}/>
      <rect x="17" y="8" width="4" height="2" fill={color}/>
      ...
      <rect x="7" y="20" width="8" height="2" fill={color}/>
