...
export function HomeSharpsolidIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className} style={style}>
      ...
      <rect x="4" y="8" width="6" height="12" fill={color}/>
      <rect x="6" y="6" width="2" height="2" fill={color}/>
      <rect x="8" y="4" width="8" height="8" fill={color}/>
      ...
      <rect x="14" y="8" width="6" height="12" fill={color}/>
