...
export function DownasaurIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="4" y="21" width="10" height="2" fill={color}/>
      <rect x="14" y="9" width="8" height="2" fill={color}/>
