...
export function BeerOffSharpIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
      ...
      style={style}
    >
      <rect x="5" y="10" width="2" height="12" fill={color}/>
      <rect x="7" y="20" width="10" height="2" fill={color}/>
      <rect x="17" y="8" width="2" height="4" fill={color}/>
      <rect x="19" y="8" width="2" height="2" fill={color}/>
      <rect x="21" y="8" width="2" height="8" fill={color}/>
      ...
      <rect x="13" y="6" width="2" height="2" fill={color}/>
      <rect x="15" y="8" width="2" height="2" fill={color}/>
      <rect x="5" y="4" width="2" height="2" fill={color}/>
      <rect x="9" y="2" width="10" height="2" fill={color}/>
      <rect x="19" y="4" width="2" height="4" fill={color}/>
      ...
      <rect x="21" y="20" width="2" height="2" fill={color}/>
    </svg>
  );
}
