...
export function TreesIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
      ...
      style={style}
    >
      <rect x="5" y="3" width="8" height="2" fill={color}/>
      ...
      <rect x="21" y="9" width="2" height="6" fill={color}/>
      ...
      <rect x="1" y="9" width="2" height="6" fill={color}/>
