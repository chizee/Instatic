...
export function ClockPlusIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect width="8" height="2" transform="matrix(1 0 0 -1 10 22)" fill={color}/>
      ...
      <rect x="4" y="16" width="2" height="6" fill={color}/>
