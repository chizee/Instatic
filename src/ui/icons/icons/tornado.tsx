...
export function TornadoIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="6" width="12" height="2" fill={color}/>
      ...
      <rect x="16" y="20" width="2" height="4" fill={color}/>
      <rect x="14" y="16" width="2" height="4" fill={color}/>
      <rect x="12" y="22" width="4" height="2" fill={color}/>
