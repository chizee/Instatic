...
export function CelsiusSquareSharpIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="10" y="9" width="2" height="6" fill={color}/>
      <rect x="12" y="7" width="4" height="2" fill={color}/>
      <rect x="12" y="15" width="4" height="2" fill={color}/>
