...
export function EstateSharpIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="16" y="10" width="6" height="2" fill={color}/>
      <rect x="20" y="12" width="2" height="6" fill={color}/>
      <rect x="16" y="12" width="2" height="6" fill={color}/>
