...
export function BusIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="2" y="5" width="18" height="2" fill={color}/>
      <rect x="22" y="9" width="2" height="8" fill={color}/>
      ...
      <rect x="18" y="17" width="4" height="2" fill={color}/>
