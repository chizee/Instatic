...
export function AmpersandIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
      ...
      style={style}
    >
      <rect x="15" y="11" width="6" height="2" fill={color}/>
      ...
      <rect x="5" y="19" width="8" height="2" fill={color}/>
