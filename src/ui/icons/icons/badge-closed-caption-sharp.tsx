...
export function BadgeClosedCaptionSharpIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="15" y="8" width="4" height="2" fill={color}/>
    </svg>
  );
}
