...
export function CutSharpIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
      ...
      style={style}
    >
      <rect x="1" y="15" width="2" height="8" fill={color}/>
      <rect x="15" y="17" width="2" height="4" fill={color}/>
      <rect x="3" y="21" width="6" height="2" fill={color}/>
      <rect x="15" y="21" width="6" height="2" fill={color}/>
      ...
      <rect x="21" y="15" width="2" height="8" fill={color}/>
