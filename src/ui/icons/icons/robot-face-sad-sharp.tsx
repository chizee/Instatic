...
export function RobotFaceSadSharpIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect width="2" height="2" transform="matrix(1 0 0 -1 14 18)" fill={color}/>
      <rect width="4" height="2" transform="matrix(1 0 0 -1 10 16)" fill={color}/>
