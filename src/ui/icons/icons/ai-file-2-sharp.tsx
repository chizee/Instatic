...
export function AiFile2SharpIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="7" y="14" width="2" height="5" fill={color}/>
      <rect x="9" y="15" width="2" height="2" fill={color}/>
      <rect x="7" y="12" width="6" height="2" fill={color}/>
      <rect x="11" y="14" width="2" height="5" fill={color}/>
      <rect x="14" y="12" width="2" height="7" fill={color}/>
    </svg>
  );
}
