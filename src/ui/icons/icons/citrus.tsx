...
export function CitrusIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
      ...
      style={style}
    >
      <rect x="7" y="19" width="12" height="2" fill={color}/>
      ...
      <rect x="3" y="5" width="2" height="12" fill={color}/>
      ...
      <rect x="7" y="7" width="2" height="8" fill={color}/>
