...
export function YoutubeIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
      ...
      style={style}
    >
      <rect x="8" y="7" width="2" height="10" fill={color}/>
      ...
      <rect x="9" y="15" width="3" height="2" fill={color}/>
