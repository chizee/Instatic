...
export function AttachmentMinusSharpIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="19" y="3" width="12" height="2" transform="rotate(90 19 3)" fill={color}/>
      ...
      <rect x="15" y="19" width="2" height="6" transform="rotate(90 15 19)" fill={color}/>
    </svg>
  );
}
