...
export function CornerLeftDownIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
      ...
      style={style}
    >
      <rect width="14" height="2" transform="matrix(4.37114e-08 1 1 -4.37114e-08 8 6)" fill={color}/>
