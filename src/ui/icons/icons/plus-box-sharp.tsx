...
export function PlusBoxSharpIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="11" y="17" width="10" height="2" transform="rotate(-90 11 17)" fill={color}/>
    </svg>
  );
}
