...
export function AnalyticsSharpIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="7" y="14" width="2" height="4" fill={color}/>
      <rect x="15" y="6" width="2" height="12" fill={color}/>
    </svg>
  );
}
