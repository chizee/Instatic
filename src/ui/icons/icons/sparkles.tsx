...
export function SparklesIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="19" y="1" width="2" height="6" fill={color}/>
      <rect x="17" y="3" width="6" height="2" fill={color}/>
      <rect x="3" y="17" width="2" height="2" fill={color}/>
      <rect x="1" y="19" width="2" height="2" fill={color}/>
      <rect x="3" y="21" width="2" height="2" fill={color}/>
