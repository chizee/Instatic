...
export function WarehousePlusIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="6" y="10" width="2" height="10" fill={color}/>
      <rect x="8" y="15" width="8" height="2" fill={color}/>
      <rect x="2" y="20" width="20" height="2" fill={color}/>
      <rect x="16" y="10" width="2" height="10" fill={color}/>
      ...
      <rect x="18" y="2" width="2" height="6" fill={color}/>
