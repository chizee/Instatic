...
export function AlignVerticalJustifyEndIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="6" y="18" width="2" height="12" transform="rotate(-90 6 18)" fill={color}/>
      <rect x="18" y="16" width="3" height="2" transform="rotate(-90 18 16)" fill={color}/>
      <rect x="6" y="13" width="2" height="12" transform="rotate(-90 6 13)" fill={color}/>
