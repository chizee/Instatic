...
export function FileBigUpsertIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect width="14" height="2" transform="matrix(-1 0 0 1 18 2)" fill={color}/>
      <rect width="2" height="14" transform="matrix(-1 0 0 1 22 6)" fill={color}/>
      <rect width="5" height="2" transform="matrix(-1 0 0 1 20 20)" fill={color}/>
