...
export function TractorIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
      ...
      style={style}
    >
      <rect x="1" y="3" width="12" height="2" fill={color}/>
      ...
      <rect x="21" y="13" width="2" height="6" fill={color}/>
      <rect x="11" y="13" width="2" height="4" fill={color}/>
      <rect x="1" y="13" width="2" height="4" fill={color}/>
      ...
      <rect x="11" y="17" width="6" height="2" fill={color}/>
