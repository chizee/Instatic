...
export function SwitchCameraSharpIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="1" y="18" width="9" height="2" fill={color}/>
      <rect x="21" y="6" width="7" height="2" transform="rotate(180 21 6)" fill={color}/>
      <rect x="12" y="18" width="9" height="2" fill={color}/>
      <rect x="12" y="6" width="11" height="2" transform="rotate(180 12 6)" fill={color}/>
