...
export function GroupSharpIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect width="6" height="2" transform="matrix(1 0 0 -1 16 22)" fill={color}/>
      <rect width="6" height="2" transform="matrix(-1 0 0 1 8 2)" fill={color}/>
      <rect x="8" y="22" width="6" height="2" transform="rotate(180 8 22)" fill={color}/>
      ...
      <rect x="12" y="6" width="2" height="5" fill={color}/>
    </svg>
  );
}
