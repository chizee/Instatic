...
export function ArrowDownNarrowWideIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="10" y="7" width="9" height="2" fill={color}/>
