...
export function CuboidIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
      ...
      style={style}
    >
      <rect width="4" height="2" transform="matrix(-1 0 0 1 13 13)" fill={color}/>
      <rect width="4" height="2" transform="matrix(-1 0 0 1 13 21)" fill={color}/>
      <rect width="4" height="2" transform="matrix(-1 0 0 1 9 11)" fill={color}/>
      <rect width="4" height="2" transform="matrix(-1 0 0 1 9 19)" fill={color}/>
      <rect width="2" height="8" transform="matrix(-1 0 0 1 13 13)" fill={color}/>
      ...
      <rect width="4" height="2" transform="matrix(-1 0 0 1 15 1)" fill={color}/>
      <rect width="4" height="2" transform="matrix(-1 0 0 1 19 3)" fill={color}/>
