...
export function DebugOffIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="16" y="8" width="2" height="5" fill={color}/>
      ...
      <rect width="2" height="2" transform="matrix(-1 0 0 1 22 20)" fill={color}/>
      <rect x="2" y="6" width="2" height="2" fill={color}/>
      <rect width="2" height="2" transform="matrix(-1 0 0 1 22 6)" fill={color}/>
