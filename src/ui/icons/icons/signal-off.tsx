...
export function SignalOffIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
      ...
      style={style}
    >
      <rect x="19" y="3" width="2" height="12" fill={color}/>
      <rect x="15" y="7" width="2" height="4" fill={color}/>
      <rect x="11" y="11" width="2" height="10" fill={color}/>
