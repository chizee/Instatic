...
export function FahrenheitSquareSharpIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="10" y="9" width="2" height="8" fill={color}/>
