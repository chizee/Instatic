...
export function DiamondGemIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="1" y="7" width="2" height="6" fill={color}/>
      ...
      <rect x="9" y="13" width="2" height="3" fill={color}/>
      <rect x="11" y="16" width="2" height="3" fill={color}/>
      <rect x="13" y="13" width="2" height="3" fill={color}/>
