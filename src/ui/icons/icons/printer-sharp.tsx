...
export function PrinterSharpIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="2" y="18" width="4" height="2" fill={color}/>
      <rect x="6" y="14" width="12" height="2" fill={color}/>
      <rect x="6" y="14" width="2" height="8" fill={color}/>
      <rect x="8" y="20" width="8" height="2" fill={color}/>
      <rect x="16" y="14" width="2" height="8" fill={color}/>
      <rect x="18" y="18" width="4" height="2" fill={color}/>
