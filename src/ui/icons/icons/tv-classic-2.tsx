...
export function TvClassic2Icon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
      ...
      style={style}
    >
      <rect width="16" height="2" transform="matrix(1 0 0 -1 4 20)" fill={color}/>
      <rect width="16" height="2" transform="matrix(1 0 0 -1 4 8)" fill={color}/>
