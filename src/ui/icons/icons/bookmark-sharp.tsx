...
export function BookmarkSharpIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="4" y="4.00012" width="2" height="18" fill={color}/>
      <rect x="18" y="4.00012" width="2" height="18" fill={color}/>
