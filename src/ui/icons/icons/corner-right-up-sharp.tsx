...
export function CornerRightUpSharpIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
      ...
      style={style}
    >
      <rect width="16" height="2" transform="matrix(-4.37114e-08 -1 -1 4.37114e-08 16 20)" fill={color}/>
