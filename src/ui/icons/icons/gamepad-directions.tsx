...
export function GamepadDirectionsIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect width="2" height="2" transform="matrix(1 0 0 -1 11 16)" fill={color}/>
