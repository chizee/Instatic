...
export function AlignVerticalSpaceBetweenSharpIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="4" y="16" width="2" height="16" transform="rotate(-90 4 16)" fill={color}/>
      <rect x="7" y="8" width="3" height="2" transform="rotate(-90 7 8)" fill={color}/>
      <rect x="7" y="10" width="2" height="10" transform="rotate(-90 7 10)" fill={color}/>
