...
export function SortNumericSharpIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="8" y="8" width="6" height="2" fill={color}/>
      <rect x="8" y="14" width="6" height="2" fill={color}/>
      <rect x="8" y="11" width="6" height="2" fill={color}/>
      <rect x="16" y="8" width="4" height="2" fill={color}/>
      ...
      <rect x="8" y="11" width="2" height="5" fill={color}/>
