...
export function AlignHorizontalDistributeStartIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect width="2" height="6" transform="matrix(-1 0 0 1 20 9)" fill={color}/>
