...
export function FacebookCircleIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="10" y="9" width="2" height="11" fill={color}/>
      <rect x="8" y="12" width="6" height="2" fill={color}/>
    </svg>
  );
}
