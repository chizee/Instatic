...
export function ChartsSharpIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="1" y="16" width="18" height="2" fill={color}/>
      <rect x="5" y="20" width="18" height="2" fill={color}/>
      <rect x="1" y="4" width="2" height="12" fill={color}/>
      <rect x="17" y="4" width="2" height="12" fill={color}/>
      <rect x="21" y="6" width="2" height="14" fill={color}/>
