...
export function ArchiveRestoreSharpIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
      ...
      style={style}
    >
      <rect x="1" y="2" width="22" height="2" fill={color}/>
      ...
      <rect x="3" y="20" width="6" height="2" fill={color}/>
      <rect x="15" y="20" width="6" height="2" fill={color}/>
