...
export function FacebookIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
      ...
      style={style}
    >
      <rect x="9" y="14" width="2" height="8" fill={color}/>
      <rect x="11" y="20" width="2" height="2" fill={color}/>
      <rect x="13" y="14" width="2" height="8" fill={color}/>
      <rect x="15" y="14" width="4" height="2" fill={color}/>
      <rect x="6" y="14" width="3" height="2" fill={color}/>
      <rect x="6" y="10" width="2" height="4" fill={color}/>
      <rect x="8" y="10" width="3" height="2" fill={color}/>
      <rect x="9" y="6" width="2" height="4" fill={color}/>
      <rect x="17" y="2" width="2" height="6" fill={color}/>
