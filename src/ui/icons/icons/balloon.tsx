...
export function BalloonIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="17" y="5" width="2" height="8" fill={color}/>
      <rect x="7" y="13" width="2" height="2" fill={color}/>
      <rect x="9" y="15" width="2" height="2" fill={color}/>
      <rect x="13" y="19" width="4" height="2" fill={color}/>
      <rect x="11" y="15" width="4" height="2" fill={color}/>
