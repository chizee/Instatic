...
export function BoomBoxSharpIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
      ...
      style={style}
    >
      <rect x="1" y="8" width="22" height="2" fill={color}/>
      <rect x="1" y="20" width="22" height="2" fill={color}/>
      <rect x="1" y="10" width="2" height="10" fill={color}/>
      <rect x="21" y="10" width="2" height="10" fill={color}/>
      ...
      <rect x="13" y="16" width="6" height="2" fill={color}/>
