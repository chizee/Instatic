...
export function ShipIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="2" y="10" width="20" height="2" fill={color}/>
      ...
      <rect x="12" y="18" width="4" height="2" fill={color}/>
      <rect x="16" y="16" width="4" height="2" fill={color}/>
