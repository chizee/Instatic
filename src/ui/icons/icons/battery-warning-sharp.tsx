...
export function BatteryWarningSharpIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="12" y="17" width="2" height="2" transform="rotate(180 12 17)" fill={color}/>
      <rect x="12" y="13" width="2" height="6" transform="rotate(180 12 13)" fill={color}/>
    </svg>
  );
}
