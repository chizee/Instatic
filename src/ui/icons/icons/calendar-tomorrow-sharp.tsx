...
export function CalendarTomorrowSharpIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="11" y="12" width="6" height="2" fill={color}/>
      <rect x="11" y="12" width="2" height="6" fill={color}/>
      <rect x="11" y="16" width="5" height="2" fill={color}/>
