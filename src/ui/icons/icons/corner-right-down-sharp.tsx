...
export function CornerRightDownSharpIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
      ...
      style={style}
    >
      <rect x="16" y="4" width="16" height="2" transform="rotate(90 16 4)" fill={color}/>
