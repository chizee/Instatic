...
export function SplineCursorIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="4" y="8" width="2" height="5" fill={color}/>
      <rect x="6" y="6" width="2" height="2" fill={color}/>
      <rect x="8" y="4" width="5" height="2" fill={color}/>
    </svg>
  );
}
