...
export function GoogleIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
      ...
      style={style}
    >
      <rect x="13" y="11" width="6" height="2" fill={color}/>
      ...
      <rect x="19" y="11" width="2" height="6" fill={color}/>
