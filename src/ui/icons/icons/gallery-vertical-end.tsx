...
export function GalleryVerticalEndIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
      ...
      style={style}
    >
      <rect x="22" y="12" width="8" height="2" transform="rotate(90 22 12)" fill={color}/>
      <rect x="20" y="10" width="2" height="16" transform="rotate(90 20 10)" fill={color}/>
      <rect x="4" y="12" width="8" height="2" transform="rotate(90 4 12)" fill={color}/>
