...
export function TentIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="3" y="17" width="2" height="3" fill={color}/>
      <rect x="5" y="14" width="2" height="3" fill={color}/>
      ...
      <rect x="13" y="8" width="2" height="3" fill={color}/>
      <rect x="15" y="11" width="2" height="3" fill={color}/>
      <rect x="17" y="14" width="2" height="3" fill={color}/>
