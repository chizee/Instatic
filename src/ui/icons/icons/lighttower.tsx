...
export function LighttowerIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect y="19" width="4" height="2" fill={color}/>
      <rect x="4" y="21" width="4" height="2" fill={color}/>
      <rect x="8" y="19" width="4" height="2" fill={color}/>
      <rect x="12" y="21" width="4" height="2" fill={color}/>
      <rect x="16" y="19" width="4" height="2" fill={color}/>
      <rect x="20" y="21" width="4" height="2" fill={color}/>
