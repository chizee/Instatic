...
export function UnderlineBoxSharpIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="8" y="7" width="2" height="5" fill={color}/>
      <rect x="14" y="7" width="2" height="5" fill={color}/>
