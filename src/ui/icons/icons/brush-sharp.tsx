...
export function BrushSharpIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
      ...
      style={style}
    >
      <rect x="5" y="2" width="12" height="2" fill={color}/>
      <rect x="5" y="4" width="2" height="10" fill={color}/>
      <rect x="17" y="2" width="2" height="12" fill={color}/>
