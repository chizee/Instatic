...
export function Fish2Icon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect width="2" height="2" transform="matrix(1 0 0 -1 14 21)" fill={color}/>
      <rect x="12" y="1" width="2" height="2" fill={color}/>
      <rect width="2" height="2" transform="matrix(1 0 0 -1 12 23)" fill={color}/>
      <rect x="18" y="15" width="2" height="2" fill={color}/>
      <rect x="12" y="17" width="6" height="2" fill={color}/>
      <rect x="12" y="5" width="6" height="2" fill={color}/>
