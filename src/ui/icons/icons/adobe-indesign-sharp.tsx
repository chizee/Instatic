...
export function AdobeIndesignSharpIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="11" y="11" width="6" height="2" fill={color}/>
      <rect x="11" y="15" width="6" height="2" fill={color}/>
      <rect x="11" y="13" width="2" height="2" fill={color}/>
      <rect x="15" y="7" width="2" height="8" fill={color}/>
    </svg>
  );
}
