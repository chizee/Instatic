...
export function ImageUpscaleSharpIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="20" y="12" width="2" height="3" fill={color}/>
      <rect x="15" y="2" width="7" height="2" fill={color}/>
