...
export function ForwardSharpIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="2" y="19" width="6" height="2" fill={color}/>
      <rect x="6" y="15" width="4" height="2" fill={color}/>
      <rect x="4" y="7" width="6" height="2" fill={color}/>
      <rect x="10" y="15" width="2" height="6" fill={color}/>
