...
export function GpuSharpIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
      ...
      style={style}
    >
      <rect x="1" y="2" width="2" height="20" fill={color}/>
      <rect x="3" y="4" width="20" height="2" fill={color}/>
      <rect x="21" y="6" width="2" height="10" fill={color}/>
      <rect x="3" y="16" width="20" height="2" fill={color}/>
