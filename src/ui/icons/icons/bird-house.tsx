...
export function BirdHouseIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="17" y="8" width="2" height="10" fill={color}/>
      ...
      <rect x="5" y="8" width="2" height="10" fill={color}/>
      ...
      <rect x="9" y="11" width="2" height="4" fill={color}/>
