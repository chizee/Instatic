...
export function ScanSearchSharpIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="9" y="7" width="4" height="2" fill={color}/>
      <rect x="7" y="9" width="2" height="4" fill={color}/>
      <rect x="9" y="13" width="4" height="2" fill={color}/>
