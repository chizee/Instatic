...
export function TrendingUpDownIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="16" y="3" width="6" height="2" fill={color}/>
      <rect x="20" y="3" width="2" height="6" fill={color}/>
      <rect x="19" y="14" width="2" height="6" fill={color}/>
