...
export function AiFileGlyphIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
      ...
      style={style}
    >
      <rect width="10" height="8" transform="matrix(-1 0 0 1 14 4)" fill={color}/>
      ...
      <rect width="6" height="10" transform="matrix(-1 0 0 1 20 12)" fill={color}/>
      <rect x="16" y="4" width="2" height="2" fill={color}/>
      <rect x="12" y="4" width="2" height="6" fill={color}/>
      <rect x="4" y="8" width="14" height="4" fill={color}/>
      ...
      <rect x="2" y="14" width="6" height="2" fill={color}/>
