...
export function ChartColumnStackedIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="15" y="6" width="2" height="10" fill={color}/>
      <rect x="6" y="8" width="2" height="8" fill={color}/>
      <rect x="20" y="6" width="2" height="10" fill={color}/>
      <rect x="11" y="8" width="2" height="8" fill={color}/>
      <rect x="8" y="12" width="3" height="2" fill={color}/>
      <rect x="17" y="8" width="3" height="2" fill={color}/>
    </svg>
  );
}
