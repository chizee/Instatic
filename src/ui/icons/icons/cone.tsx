...
export function ConeIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect width="6" height="2" transform="matrix(-1 0 0 1 15 21)" fill={color}/>
      <rect width="6" height="2" transform="matrix(-1 0 0 1 15 13)" fill={color}/>
