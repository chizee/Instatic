...
export function InvertSharpIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="4" y="10" width="10" height="2" fill={color}/>
      <rect x="4" y="8" width="12" height="2" fill={color}/>
      <rect x="4" y="6" width="14" height="2" fill={color}/>
