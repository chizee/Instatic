...
export function FolderXSharpIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
      ...
      style={style}
    >
      <rect x="2" y="4" width="10" height="2" fill={color}/>
      <rect x="2" y="18" width="12" height="2" fill={color}/>
      ...
      <rect x="20" y="18" width="2" height="2" transform="rotate(90 20 18)" fill={color}/>
