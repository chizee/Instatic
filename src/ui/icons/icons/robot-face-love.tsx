...
export function RobotFaceLoveIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
      ...
      style={style}
    >
      <g clip-path="url(#clip0_496_1502)">
      <rect x="4" y="4" width="14" height="2" fill={color}/>
      <rect x="4" y="18" width="8" height="2" fill={color}/>
      <rect x="2" y="6" width="2" height="12" fill={color}/>
      <rect x="18" y="6" width="2" height="6" fill={color}/>
      ...
      <rect x="13" width="4" height="2" fill={color}/>
      <rect y="10" width="2" height="2" fill={color}/>
