...
export function CameraPlaySharpIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
      ...
      style={style}
    >
      <rect y="5" width="6" height="2" fill={color}/>
      <rect x="4" y="3" width="12" height="2" fill={color}/>
      <rect x="14" y="5" width="6" height="2" fill={color}/>
      <rect y="7" width="2" height="12" fill={color}/>
      <rect y="19" width="14" height="2" fill={color}/>
      <rect x="18" y="7" width="2" height="5" fill={color}/>
