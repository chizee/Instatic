...
export function SettingsCog2PlusIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="22" y="14" width="2" height="6" transform="rotate(180 22 14)" fill={color}/>
      ...
      <rect x="18" y="22" width="6" height="2" transform="rotate(-90 18 22)" fill={color}/>
    </svg>
  );
}
