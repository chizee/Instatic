...
export function BadgeCaptionsOffSharpIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
      ...
      style={style}
    >
      <rect x="11" y="4" width="12" height="2" fill={color}/>
      <rect x="3" y="18" width="18" height="2" fill={color}/>
      <rect x="1" y="6" width="2" height="14" fill={color}/>
      <rect x="21" y="6" width="2" height="10" fill={color}/>
