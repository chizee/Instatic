...
export function AlignVerticalDistributeCenterIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect width="2" height="8" transform="matrix(-4.37114e-08 -1 -1 4.37114e-08 16 15)" fill={color}/>
      <rect width="2" height="4" transform="matrix(-4.37114e-08 -1 -1 4.37114e-08 14 5)" fill={color}/>
      ...
      <rect width="2" height="8" transform="matrix(-4.37114e-08 -1 -1 4.37114e-08 16 21)" fill={color}/>
      <rect width="2" height="4" transform="matrix(-4.37114e-08 -1 -1 4.37114e-08 14 11)" fill={color}/>
