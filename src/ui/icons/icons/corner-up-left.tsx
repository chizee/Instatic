...
export function CornerUpLeftIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect width="2" height="10" transform="matrix(-1 0 0 1 20 10)" fill={color}/>
