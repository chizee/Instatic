...
export function EdgeIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="13" y="20" width="5" height="2" fill={color}/>
      <rect x="4" y="4" width="7" height="2" fill={color}/>
      <rect x="2" y="6" width="2" height="3" fill={color}/>
      <rect x="4" y="4" width="2" height="3" fill={color}/>
      <rect x="18" y="4" width="2" height="2" fill={color}/>
      <rect x="4" y="18" width="2" height="2" fill={color}/>
      <rect x="6" y="8" width="2" height="14" fill={color}/>
      ...
      <rect x="15" y="18" width="5" height="2" fill={color}/>
      <rect x="8" y="8" width="2" height="2" fill={color}/>
      <rect x="4" y="10" width="2" height="2" fill={color}/>
      <rect x="9" y="12" width="2" height="7" fill={color}/>
      <rect x="12" y="6" width="2" height="6" fill={color}/>
      <rect x="14" y="12" width="6" height="2" fill={color}/>
