...
export function BetweenHorizontalStartSharpIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
      ...
      style={style}
    >
      <rect width="2" height="16" transform="matrix(4.37114e-08 1 1 -4.37114e-08 6 2)" fill={color}/>
      ...
      <rect width="2" height="14" transform="matrix(3.82475e-08 1 1 -4.99559e-08 8 9)" fill={color}/>
      <rect width="2" height="16" transform="matrix(4.37114e-08 1 1 -4.37114e-08 6 20)" fill={color}/>
      <rect width="2" height="14" transform="matrix(3.82475e-08 1 1 -4.99559e-08 8 13)" fill={color}/>
