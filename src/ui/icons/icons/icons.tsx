...
export function IconsIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
      ...
      style={style}
    >
      <rect x="3" y="1" width="6" height="2" fill={color}/>
      <rect x="1" y="3" width="2" height="6" fill={color}/>
      ...
      <rect x="21" y="9" width="2" height="2" fill={color}/>
      ...
      <rect x="13" y="13" width="10" height="2" fill={color}/>
      <rect x="13" y="21" width="10" height="2" fill={color}/>
      <rect x="13" y="15" width="2" height="6" fill={color}/>
      <rect x="21" y="15" width="2" height="6" fill={color}/>
      ...
      <rect x="1" y="19" width="2" height="4" fill={color}/>
      <rect x="9" y="19" width="2" height="4" fill={color}/>
      <rect x="1" y="21" width="10" height="2" fill={color}/>
    </svg>
  );
}
