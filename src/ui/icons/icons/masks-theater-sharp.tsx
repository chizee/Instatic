...
export function MasksTheaterSharpIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
      ...
      style={style}
    >
      <g clipPath="url(#clip0_496_1101)">
        <rect x="14" y="18" width="4" height="2" fill={color}/>
        <rect width="4" height="2" transform="matrix(1 0 0 -1 6 10)" fill={color}/>
        ...
        <rect x="12" y="8" width="12" height="2" fill={color}/>
        <rect width="16" height="2" fill={color}/>
        <rect x="8" y="12" width="2" height="10" fill={color}/>
        <rect y="2" width="2" height="12" fill={color}/>
        ...
        <rect y="14" width="6" height="2" fill={color}/>
      </g>
      <defs>
        <clipPath id="clip0_496_1101">
