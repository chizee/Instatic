...
export function AnchorSharpIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="11" y="9" width="2" height="12" fill={color}/>
      <rect x="5" y="20" width="14" height="2" fill={color}/>
      <rect x="3" y="12" width="2" height="10" fill={color}/>
      <rect x="19" y="12" width="2" height="10" fill={color}/>
