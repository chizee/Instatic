...
export function BanknoteDownSharpIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="21" y="7" width="2" height="8" fill={color}/>
      ...
      <rect x="13" y="17" width="10" height="2" fill={color}/>
    </svg>
  );
}
